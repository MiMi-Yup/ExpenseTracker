...
import 'package:expense_tracker/services/firebase/firestore/utilities/account_types.dart';
...
class AddEditAccountTypes extends StatefulWidget {
  const AddEditAccountTypes({Key? key}) : super(key: key);

  @override
  State<AddEditAccountTypes> createState() => _AddEditAccountTypesState();
}

class _AddEditAccountTypesState extends State<AddEditAccountTypes> {
  late double height = MediaQuery.of(context).size.height;
  String? pathImage;
  String? errorText;
  ModalAccountType modal = ModalAccountType(
